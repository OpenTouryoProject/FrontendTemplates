...
export default class CrudSample extends React.Component {
    ...
    render() {
        return <div>
            ...
            { CrudSample.renderForecastsTable(this.props.forecasts) }
            { CrudSample.renderPagination(this.props.startDateIndex) }
        </div>;
    }

    static renderForecastsTable(forecasts) {
        console.log("components/CrudSample.renderForecastsTable: " + JSON.stringify(forecasts));
